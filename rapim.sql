...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Agu 2017 pada 11.20
-- Versi Server: 5.6.21
-- PHP Version: 5.5.19
...
(1, 'WhatsApp Image 2017-08-05 at 07.jpeg', 'August 5, 2017, 3:13 pm'),
(2, 'WhatsApp_Image_2017-08-05_at_07.jpeg', 'August 5, 2017, 3:50 pm'),
(3, 'Daftar_Peserta_RAPIM_SM_1_2017-db.xlsx', 'August 5, 2017, 3:51 pm');
...
INSERT INTO `data_undangan` (`id`, `nik`, `nama`, `posisi`, `band`, `lokasi_kerja`, `unit`, `kota`, `telepon`, `kategori`, `foto`, `status`, `waktu_absen`) VALUES
(1, '660338', 'SUPARWIYANTO, IR.', 'EVP TELKOM REGIONAL V', 'I', 'Telkom Regional V', 'Kantor Telkom Regional V', 'Surabaya', '089635095619', 'Pegawai_Telkom', 'images/660338.jpg', 'hadir', 'August 5, 2017, 3:57 pm'),
(2, '680359', 'DJATMIKO', 'DEPUTY EVP MARKETING', 'I', 'Marketing', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
(3, '670169', 'RIJANTO UTOMO, RADEN, IR', 'DEPUTY EVP INFRASTRUCTURE', 'I', 'Infrastructure', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
(4, '670155', 'SETYA HERMAWAN', 'SM BUSINESS PLANNING & PERFORMANCE', 'II', 'Business Planning & Performance', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
(5, '611731', 'MOHAMAD AKBAN KUKUH WARGONO', 'SM PAYMENT COLLECTION & FINANCE', 'II', 'Payment Collection & Finance', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
...
(30, '720163', 'SUGENG WIYOGOTO', 'MGR PERFORMANCE & WAR ROOM', 'III', 'Performance & War Room', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
(31, '800022', 'SITI KHOLIFAH', 'MGR QUALITY & CHANGE MANAGEMENT', 'III', 'Quality & Change Management', 'Kantor Telkom Regional V', 'Surabaya', '', 'Pegawai_Telkom', '', '', ''),
...
(81, '1', '', 'MGR HOME SERVICE 2', 'III', 'Home Service', 'WITEL Denpasar', 'Denpasar', '', 'Pegawai_Telkom', '', '', ''),
(82, '999999', 'AGUS TEMON', 'TKM', '', 'Telkom Regional V', 'Telkom Regional V', 'Surabaya', '', 'Panitia', '', '', ''),
...
(91, '2', '', '', '', '', '', '', '2', '', 'images/2.jpg', 'pengganti', 'August 5, 2017, 3:58 pm');
